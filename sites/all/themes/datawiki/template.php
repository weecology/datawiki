 ...
 * Page alter.
 */
function datawiki_page_alter($page) {
 ...
 */
function datawiki_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
 ...
 */
function datawiki_process_html(&$vars) {
...
function datawiki_preprocess_page(&$vars) {
	...
	/**
  * Recognize content type templates
  */
 ...
 */
function datawiki_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function datawiki_preprocess_block(&$variables) {
 ...
 */
function datawiki_breadcrumb($variables) {
...
/**
 * Converts respnosive menu title to hamburger button
 */

function datawiki_superfish($variables) {
